"""
Scenario: Cooperative coverage of 16 agents
...
class Scenario(BaseScenario):
    def make_world(self):
        ...
        self.world_radius = 2.3  # camera range (2.2 for 15 agents)
        self.n_others = 6  # (5 for 15 agents)
        self.np_rnd = np.random.RandomState(0)  # 获得随机数生成器，数字为随机种子
        # add agents
        ...
        self.collision_threshold = 2 * world.agents[0].size  # 碰撞阈值
